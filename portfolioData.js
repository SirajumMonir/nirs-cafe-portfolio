export const portfolioData = {
  engineer: {
    ...
    tagline: "Building autonomous systems, deep learning pipelines, and production-ready intelligent architectures.",
    stats: [
      { label: "Models Trained", value: "60+" },
      { label: "Inference Speedup", value: "4.2x" },
      { label: "Deep Learning Hours", value: "2.4k+" },
      { label: "Systems Deployed", value: "18" }
    ]
  },
  home: {
    ...
    pillars: [
      ...
      { title: "Deep Learning", desc: "Custom transformer models, CNN architectures, and GANs.", color: "border-amber-500/30 text-amber-400" },
      { title: "Computer Vision", desc: "Real-time object detection, segmentation, and synthetic generation.", color: "border-emerald-500/30 text-[#39FF14]" },
      { title: "Model Finetuning", desc: "Quantized PEFT/LoRA adapters, alignment, and fast embedding extraction.", color: "border-rose-500/30 text-rose-400" },
      { title: "NLP Swarms", desc: "Architecting high-accuracy retrieval systems and complex translation.", color: "border-sky-500/30 text-sky-400" },
      { title: "AI Agents", desc: "Autonomous multi-agent task execution and self-healing systems.", color: "border-violet-500/30 text-violet-400" }
    ]
  },
  about: {
    bio: "An AI/ML Engineer with a devotion to building systems that bridge raw mathematical theories with production-ready real world assets. Grounded by an unyielding discipline, I construct models that can see, hear, comprehend, and optimize automatically.",
    education: [
      { school: "Kushtia Zilla School", degree: "Secondary School Education (Science)", url: "https://www.facebook.com/kzs.edu.bd/" },
      { school: "Kushtia Govt. Central College", degree: "Higher Secondary Education (Science)", url: "http://kgcc.edu.bd" },
      { school: "Daffodil International University", degree: "B.Sc. in Computer Science & Engineering", url: "https://daffodilvarsity.edu.bd" }
    ],
    skills: {
      frameworks: ["PyTorch", "TensorFlow", "Hugging Face", "LangChain", "Keras", "Scikit-Learn"],
      tools: ["Docker", "Linux (Ubuntu/Arch)", "FastAPI", "Git/GitHub", "CUDA/TensorRT", "PostgreSQL", "MLflow"]
    },
    achievements: [
      { title: "Vision Mastery Award", issuer: "DIU Robotics Lab", date: "2024" },
      { title: "ML Specialist Unlocked", issuer: "DeepLearning.AI", date: "2023" },
      { title: "Top Solver: CV Pipeline Hack", issuer: "TechFest AI", date: "2025" }
    ]
  },
  projects: [
    {
